...
### 🚨 اعلان‌های Critical
- **Always-on-top Window**: پنجره همیشه در بالای تمام برنامه‌ها (حتی بازی‌ها) نمایش داده می‌شود
- **صدای هشدار مداوم**: تا زمانی که سفارش تایید نشود، صدای هشدار به صورت loop پخش می‌شود
- **System Notification**: اعلان سیستمی با اولویت بالا برای Windows/Linux/macOS
